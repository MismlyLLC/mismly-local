					        ...
					        $agents = new OsAgentModel();
									...
									foreach($agents as $agent){
										...
										echo '<div class="gcal-agent-info">';
											...
											if($connected){
												echo '<i class="latepoint-icon latepoint-icon-check"></i><span>'.esc_html('Access Granted', 'latepoint-google-calendar').'</span>';
											}else{
												echo '<span>'.esc_html('Not Connected', 'latepoint-google-calendar').'</span>';
											}
											echo '</a>';
											if($connected){
...
$latepoint_session_salt = 'NjUxNTkyMTItMzViOC00MDI0LTgyMzktNWYxYWRlZDNkMDU4';
